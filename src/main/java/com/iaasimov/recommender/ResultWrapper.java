        ...
        if(semanticStoreQuery.getTarget() == Constants.RecommenderTarget.CLOUD_SERVICES){
            ...
            for(SolrDocument aResult : results){
                ...
                ResultSet rrest = new ResultSet(
                        ...
                        (String)aResult.getFieldValue(Constants.SERVICE_DIVISION_FIELD),
                        ...
                        (String)aResult.getFieldValue(Constants.SERVICE_DISPLAY_CUSTOMER_FIELD),
                        (String)aResult.getFieldValue(Constants.SERVICE_DISPLAY_COUNTRY_FIELD),
